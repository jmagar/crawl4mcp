...
from ..mcp_setup import mcp, LifespanContext # Import the centralized mcp instance and LifespanContext
from ..config import settings
from ..utils.logging_utils import get_logger
from ..utils.embedding_utils import get_embedding # For single query embedding
...
async def search_code_examples(
    ...
    try:
        lifespan_ctx: LifespanContext = mcp.state.lifespan_context
        qdrant_client: Optional[QdrantClient] = lifespan_ctx.qdrant_client
        reranker: Optional[CrossEncoder] = lifespan_ctx.reranking_model
